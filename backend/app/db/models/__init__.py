...
from app.db.models.knowledge_base import KnowledgeBase, UserKBOverride, DepartmentKBOverride
...
__all__ = [
    ...
    "KnowledgeBase", "UserKBOverride", "DepartmentKBOverride",
    "Document", "DocumentVersion", "DocumentProcessingTask",
    "Chunk",
    "RAGConfig",
    "ChatSession", "ChatMessage", "RagAnswerSource",
    "ModelConfig",
    "AuditLog",
    "EvalDataset", "EvalRun", "EvalResult",
    "SystemConfig",
    "user_roles", "role_permissions", "department_members",
    "Base",
]

...
class RAGConfig(Base):
    ...
    parent_chunk_size: Mapped[int] = mapped_column(Integer, default=2000)
    top_k_vector: Mapped[int] = mapped_column(Integer, default=10)
    top_k_bm25: Mapped[int] = mapped_column(Integer, default=10)
    ...
    enable_contextual_retrieval: Mapped[bool] = mapped_column(Boolean, default=False)

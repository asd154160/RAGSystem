...
class RAGConfig(Base):
    ...
    top_k_vector: Mapped[int] = mapped_column(Integer, default=7)
    top_k_bm25: Mapped[int] = mapped_column(Integer, default=7)
    rrf_k: Mapped[int] = mapped_column(Integer, default=60)
    rerank_top_n: Mapped[int] = mapped_column(Integer, default=8)
    score_threshold: Mapped[float] = mapped_column(Float, default=0.1)
